...
public class CustomerValidationRules {
	...
	public static Date seniorCitizenDate;
	static {
		try {
			endDate = sdf.parse("1-1-1995");
			seniorCitizenDate=sdf.parse("1-1-1962");
...
//add a static method , to validate all customer i/ps
	...
	public static void checkForDup(String email, Date customerDob, ArrayList<Customer> customers) throws CustomerHandlingException {
		//create customer class instance wrapping PK
		Customer c=new Customer(email, customerDob);
		if(customers.contains(c))
			throw new CustomerHandlingException("Dup Customer details !!!!!!!!!!!!!");		
