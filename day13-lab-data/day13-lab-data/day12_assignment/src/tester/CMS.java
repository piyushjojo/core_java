			...
			while (!exit) {
				...
				try {
					...
					case 7:
						...
						break;
					case 8:
						System.out.println("Sorting customer details as per email n dob , using Natural Ordering");
						Collections.sort(customers);// sort(...) will invoke : Customer's compareTo
						break;
					case 9:
						System.out
								.println("Sorting customer details as per  dob n service plan , using Custom Ordering");
